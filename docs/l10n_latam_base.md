# Módulo: LATAM Localization Base

## Información General
- **Nombre técnico:** l10n_latam_base
- **Versión:** 1.0
- **Categoría:** Accounting/Localizations
- **Dependencias:** contacts, base_vat
...
|------|--------|--------|-----------|
| list | l10n_latam.identification.type.list | `l10n_latam_base.view_l10n_latam_identification_type_tree` | - |
| search | l10n_latam.identification.type.search | `l10n_latam_base.view_l10n_latam_identification_type_search` | - |



#### Filtros de búsqueda (l10n_latam_base.view_l10n_latam_identification_type_search)
